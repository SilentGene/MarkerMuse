...
* Supports **two scoring modes**:
  ...
  * **Expert preset mode** — heuristic scoring based on marker coverage consistency, richness, and stability.
  * **Data-driven mode** — uses SingleM taxonomic-profile output to fit regression-based marker performance weights and rank markers according to how well they predict observed taxonomic coverage.
